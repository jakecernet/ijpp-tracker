...
export const ICON_SIZE_BY_LAYER = {
  buses: ["interpolate", ["linear"], ["zoom"], 8, 0.28, 12, 0.36, 14, 0.44, 16, 0.52],
  busStops: ["interpolate", ["linear"], ["zoom"], 8, 0.24, 12, 0.32, 14, 0.4, 16, 0.48],
  trainPositions: ["interpolate", ["linear"], ["zoom"], 8, 0.26, 12, 0.34, 14, 0.42, 16, 0.5],
  trainStops: ["interpolate", ["linear"], ["zoom"], 8, 0.24, 12, 0.32, 14, 0.4, 16, 0.48],
  routeStops: ["interpolate", ["linear"], ["zoom"], 8, 0.24, 12, 0.32, 14, 0.4, 16, 0.48],
}
...
export const HALO_RADIUS = ["interpolate", ["linear"], ["zoom"], 22, 22, 30, 26, 34, 30, 38, 34]
